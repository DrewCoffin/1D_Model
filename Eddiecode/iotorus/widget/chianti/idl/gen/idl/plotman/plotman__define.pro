...
pro plotman::plot, _extra=_extra, status=status, err_msg = err_msg, $
	...
	ov_charsize=ov_charsize, ov_number=ov_number, ov_panel=ov_panel, ov_squish=ov_squish;, ov_charthick=ov_charthick ;, ov_self=ov_self
...
if not overlay then begin
	...
	!p.multi = 0
	if nover gt 0 and pc.overlay_stack and not do_image then !p.multi = [0,1,nover+1,0,-1]
endif
...
;					
				...
				self -> plot, /overlay, ov_stack=pc.overlay_stack, $		; recurse to overlay plots
					...
					ov_number=ip, ov_panel=pc.overlay_panel[ip], ov_squish=ov_squish;, ov_charthick=ov_charthick ;, ov_self=ov_self
