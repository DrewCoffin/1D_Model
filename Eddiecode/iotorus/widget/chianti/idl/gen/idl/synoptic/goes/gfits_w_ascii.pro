...
;      goes_3hour_ascii, files(i), firstrec, data1
      ...
      goes_day_ascii, files[i], file_sat, data, time
      utfile = time[0]
      print,' Start time of file ', files(i), ' is ', anytim(utfile,/vms)
...
;   spawn, 'cp ' + outfile + ' ' + chklog('GOES_FITS')    ; remove this in ~ a week!!! kim 9-oct-2008
   ...
   print, 'Wrote GOES FITS file ',outfile, '  Contains ',nlast, ' points'
   print, ' '
