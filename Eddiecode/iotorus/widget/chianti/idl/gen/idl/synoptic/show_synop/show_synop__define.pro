...
;-- use data object plotman method if available
 ...
 if have_method(data,'plotman') then begin
  data->plotman,plotman=!show_synop.plotman_obj,/noclone,nodup=nodup,replace=replace, /colors
  return
 endif
...
;-- check if site requires time rounding
