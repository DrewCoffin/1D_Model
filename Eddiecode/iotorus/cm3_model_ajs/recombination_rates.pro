...
if n_elements(rrtemp) ne 81 then begin
    readcol,'/Users/steffl/iotorus/torus_model/latavg_lag/recombination_O.dat',rrtemp,rrop,$
            rro2p,rro3p,rrov,rrovi,rrovii,rrov2p,/silent,format='F,F,F,F,F,F,F,F'
    
    readcol,'/Users/steffl/iotorus/torus_model/latavg_lag/recombination_S.dat',rrs2p,rrs3p,$
            /silent,format='F,F'
endif
