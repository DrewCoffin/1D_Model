...
if n_elements(rrtemp) ne 81 then begin
    readcol,'/home/dcoffin/1D_Model/Eddiecode/iotorus/model/cm3_latavg_onebox/recombination_O.dat',rrtemp,rrop,$
            rro2p,rro3p,rrov,rrovi,rrovii,rrov2p,/silent,format='F,F,F,F,F,F,F,F'
    
    readcol,'/home/dcoffin/1D_Model/Eddiecode/iotorus/model/cm3_latavg_onebox/recombination_S.dat',rrs2p,rrs3p,$
            /silent,format='F,F'
endif
