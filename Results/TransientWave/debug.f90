MODULE DEBUG
  ...
  logical             ::OUTPUT_TEMP = .not. .true. !Variable to control outputs for plotting
  ...
  logical             ::sys3hot  = .true. !creates a hot electron population that is sationary in sys3
  logical             ::sys4hot  = .true. !creates a hot electron population that is sationary in sys3
